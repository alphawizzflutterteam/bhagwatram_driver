final String appName = 'Bhagatram Trading Company Driver';

//final String baseUrl ='https://developmentalphawizz.com/bhagatram_trading_company/delivery_boy/app/v1/api/';
final String baseUrl ='https://btchome.in/delivery_boy/app/v1/api/';
