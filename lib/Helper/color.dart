...
const Color primary = Color(0xffff3f00);
const Color secondary = Color(0xff19235e);
const Color fontColor = Color(0xff080808);
const Color grad1Color = Color(0xffff3f00);
const Color grad2Color = Color(0xffff3f00);
